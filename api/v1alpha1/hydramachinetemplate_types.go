...
type HydraMachineTemplateStatus struct {
	...
	// holds back its eviction thresholds. Measured at 6.8% for memory and 15.2%
	// for ephemeral storage -- see docs/scale-from-zero.md, which also covers the
	// annotations that override this per pool.
	//
